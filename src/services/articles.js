...
export const renderPosts = (posts) => {
	...
	<figure><img src='${social_image}' alt='Imagen del post: ${title}' /></figure>
		<button class='btn btn-circle btn-sm top-2 right-2 drop-shadow-md absolute' id='bookmarkBTN'>
